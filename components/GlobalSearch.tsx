      ...
      <div className="relative group">
        ...
        <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1">
          {query ? (
            ...
            <span className="text-xs text-gray-400 bg-gray-200/50 dark:bg-gray-700/50 px-1.5 py-0.5 rounded border border-gray-200 dark:border-gray-700 font-mono">
              ⌘K
            </span>
          )}
        </div>
            ...
            {hasResults ? (
              <div className="p-2 space-y-2">
                {filteredClaims.length > 0 && (
                  <div>
                    <h4 className="text-[10px] font-bold text-gray-400 uppercase tracking-wider px-3 py-2">
                      Claims
                    </h4>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex justify-between items-center">
                            <p className="text-sm font-medium text-gray-900 dark:text-white group-hover:text-orange-600 transition-colors truncate">
                              {claim.id}
                            </p>
